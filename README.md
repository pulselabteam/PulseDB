...
- No matter which version (the .zip or the sub-section compressred version) you have donwloaded, remember to unzip the file and put the **PulseDB_MIMIC** and **PulseDB_Vital** folders into the **Segment_Files** folder, before you start generating the **Subset** files using the provided script.
