...
- Both OneDrive and GoogleDrive do not support resume downloading from break-point. Therefore, if the download pause or fail, you have to start all over again. This have create difficulties when downloading the largest data files: PulseDB_MIMIC.zip (136GB) and PulseDB_Vital.zip (77.4GB). To resolve that problem, we have created sub-section compressed version of these two files: . Each sub-section is of 10GB. After downloading all sections, unzipping any one of the sections gives you the desired data folder.
